...
python clawdmeter_daemon.py --album ~/Pictures/claudedaemon          # feed the Pictures page
                                                     # (drop photos in the folder, tick Pictures
                                                     # in the device's Display -> Carousel; Pillow
                                                     # resizes + caches, no converter CLIs needed)
```
